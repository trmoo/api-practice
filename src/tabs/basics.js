...
export function url(host) {
  ...
  add(host, [
    ...
    card('한글은 왜 %EC%99%80 가 될까',
      note('info', '주소에는 영문·숫자와 몇몇 기호만 쓸 수 있습니다. '
        + '그래서 한글은 ', mono('%EC%99%80'), ' 같은 모양으로 바꾸어 적습니다. '
        + '지금은 이만큼만 알면 됩니다.'),
      // ⚠ 바이트 표는 어려워하는 학생이 많아 접어 둔다(2026-08-30 사용자 요청).
      details('🔬 더 깊이 — 한 글자씩 어떻게 바뀌는지 보기',
        h('p', {}, '한글 한 글자는 UTF-8 에서 보통 3바이트라, ', mono('%XX'),
          ' 가 세 번 이어 붙습니다.'),
